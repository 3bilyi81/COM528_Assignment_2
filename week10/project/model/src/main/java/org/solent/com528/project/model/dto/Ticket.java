...
public class Ticket {
    ...
    public void setZoneCount(Integer zoneCounter){
    ...
    public String toString() {
        return "Ticket{" + "startStation=" + startStation + ", cost=" + cost + ", encryptedHash=" + encryptedHash + ", rate=" + rate + ", issueDate=" + issueDate + ", ExpiryDate=" + expiryDate + '}';
    }
