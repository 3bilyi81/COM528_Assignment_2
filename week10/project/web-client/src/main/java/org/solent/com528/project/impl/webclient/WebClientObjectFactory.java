...
public class WebClientObjectFactory implements ServletContextListener {
    ...
    public static Date getLastClientUpdateAttempt() {
     ...
     //Trying to add departure time
    public static Date getSetDepratureTime() {
        return configurationPoller.getSetDepartureTime();
    }
    public static String getArrivalStation(){
    return configurationPoller.getArrivalStation();
    }
    public static Date getArrivalTime(){
    return configurationPoller.getArrivalTime();
    }
